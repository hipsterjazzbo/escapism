onEvent("recipes", (e) => {
  ...
  e.shapeless("4x minecraft:clay_ball", "minecraft:clay").id(
    `kubejs:minecraft/clay`
  );
  e.shapeless("4x minecraft:quartz", "minecraft:quartz_block").id(
    `kubejs:minecraft/quartz`
  );
  e.shapeless("minecraft:chest", "#forge:chests/wooden").id(
    `kubejs:minecraft/quartz`
  );
  e.shapeless("minecraft:crafting_table", /byg:.+_crafting_table/).id(
    `kubejs:byg_crafter_convert`
  );
  e.shapeless("9x minecraft:honeycomb", "minecraft:honeycomb_block").id(
    "kubejs:minecraft/honeycomb"
  );
  ...
  e.shaped("16x minecraft:stick", ["L", "L"], { L: "#minecraft:logs" }).id(
    `kubejs:minecraft/sticks`
  );
  ...
  colors.forEach((color) => {
    ...
    e.shaped(
      item.of(`minecraft:${color}_stained_glass`, 3),
      ["GGG", "G G", "GGG"],
    ...
    e.shapeless(`minecraft:${color}_bed`, [
      "#minecraft:beds",
      `#forge:dyes/${color}`,
    ]);
    e.shapeless(`minecraft:${color}_carpet`, [
      "#minecraft:carpets",
      `#forge:dyes/${color}`,
    ]);
  });
